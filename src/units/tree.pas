...
type
  ...
  protected
    ...
    function DoCompare(Source, Target: TSelfType; P: PtrUInt): Integer; virtual;
...
begin
  ...
  Result := DoCompare(Self, ATree, Param);
...
function TTree.DoCompare(Source, Target: TSelfType; P: PtrUInt): Integer;
begin
